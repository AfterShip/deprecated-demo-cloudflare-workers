...
async function fetchAndApply(request) {
  ...
  } else if (request.url.indexOf('https://jobs.aftershipdemo.com/') === 0) {
    const actual_url = request.url.replace('https://jobs.aftershipdemo.com/', 'https://activity.lagou.com/topic/');
